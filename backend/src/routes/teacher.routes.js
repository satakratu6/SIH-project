...
import { startSession, stopSession, scan, markAttendance } from '../controllers/attendance.controller.js'
import { listStudents, createLeaveRequest, listLeaveRequests, upsertTimetable, getTimetable, listMySections } from '../controllers/teacher.controller.js'
...
// Compatibility route for mobile app snippet
router.post('/attendance/mark', markAttendance)

// Students
router.get('/sections', requireAuth, requireRole('teacher'), listMySections)
